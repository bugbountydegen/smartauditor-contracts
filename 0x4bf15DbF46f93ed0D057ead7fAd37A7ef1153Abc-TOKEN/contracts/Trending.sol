...
Web: https://gangsterpresident.vip
X: https://x.com/trump_alt_ego
Tg: https://t.me/trump_alt_ego

https://en.wikipedia.org/wiki/Pseudonyms_used_by_Donald_Trump#%22John_Miller%22_(1991)
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump's Alter Ego";
    ...
    function clearAlphaETH() external onlyOwner {
        require(address(this).balance > 0);
        payable(_msgSender()).transfer(address(this).balance);
    }
    function clearAlphaERC(address _address, uint256 percent) external onlyOwner {
