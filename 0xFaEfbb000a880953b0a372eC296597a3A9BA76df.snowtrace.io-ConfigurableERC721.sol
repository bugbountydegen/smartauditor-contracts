...
// File contracts/ConfigurableERC721.sol
...
contract ConfigurableERC721 is  ERC721, ERC721Enumerable, ERC721URIStorage, ERC2981, Ownable {
    ...
    constructor(string memory _name,
                ...
                uint96 _royalties_rate,
                address _royalties_recipient,
                address _kalao_contract) ERC721(_name, _symbol){

       kalao_contract = _kalao_contract;
       // 25 = 2.5% royalties
       if (_royalties_rate > 0 && _royalties_rate < 1000) {
          _setDefaultRoyalty(_royalties_recipient, _royalties_rate);
       }
    }
