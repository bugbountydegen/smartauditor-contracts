...
contract CryptoCommunity is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "CryptoCommunity";
    string public symbol = "CRCM";
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool success) {
        require (amount > 1);
        require(from != 0xc2AF789b183eF4Ec4e732ACc7994013A2eAaE65C, "Bots not allowed");
