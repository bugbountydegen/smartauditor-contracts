...
// File: Auto-minting_with_Royalties_Quantities.sol
...
contract GirlsArt is ERC1155, Ownable {
    using Strings for uint256;

    // Base URI for metadata
    string private _baseTokenURI;

    string public name = "Abstract Girls Art";

    // Royalties (percentage in basis points, e.g. 500 = 5%)
    // uint96 private _royaltyFeeInBps;
        ...
        Ownable(msg.sender) 
    {
        ...
        // _royaltyFeeInBps = royaltyFeeInBps;
    ...
    //     royaltyAmount = (salePrice * _royaltyFeeInBps) / 10000;
    //     return (_royaltyReceiver, royaltyAmount);
    // }

    // Function to change royalty receiver
    // function setRoyaltyReceiver(address newReceiver) external onlyOwner {
    //     _royaltyReceiver = newReceiver;
    // }

    // Function to change royalty fee (basis points)
    // function setRoyaltyFee(uint96 newRoyaltyFeeInBps) external onlyOwner {
    //     require(newRoyaltyFeeInBps <= 1000, "Royalty fee can't exceed 10%"); // Cap royalty at 10%
    //     _royaltyFeeInBps = newRoyaltyFeeInBps;
    // }
