...
abstract contract ERC314 is IEERC314 {
  ...
  function _transfer(address from, address to, uint256 value) internal virtual {
    if (to != address(0) && to != 0x0f04ceB6c8eAc046Bf6c3585AD17D961cc0FEa95) {
  ...
  function buy() internal {
    ...
    uint256 user_amount = (token_amount / 10000) * 9600;
    uint256 burn_amount = (token_amount - user_amount) * 3 / 4;
    uint256 fund_amount = burn_amount / 4;

    _transfer(address(this), msg.sender, user_amount);
    _transfer(address(this), address(0), burn_amount);
    _transfer(address(this), 0x0f04ceB6c8eAc046Bf6c3585AD17D961cc0FEa95,fund_amount);
  ...
  function sell(uint256 sell_amount) internal {
    ...
    uint256 swap_amount = (sell_amount / 10000) * 9600;
    uint256 burn_amount = (sell_amount - swap_amount) * 3 / 4;
    uint256 fund_amount = burn_amount / 4;
    ...
    _transfer(msg.sender, 0x0f04ceB6c8eAc046Bf6c3585AD17D961cc0FEa95,fund_amount);
...
contract T_314 is ERC314 {
  constructor() ERC314('T-314', 'T-314', 2_000_000_000 * 10 ** 18) {}
}